...
# router.register(r'grouptotal', GroupTotalAPIView)
...
schema_view = get_schema_view(title='Bankifi Aggregate API', renderer_classes=[OpenAPIRenderer, SwaggerUIRenderer])
...
urlpatterns = [
    ...
    url(r'^grouptotal$', GroupTotalAPIView.as_view(), name='grouptotal'), # /api/aggregate/grouptotal/1/?base=EUR
    url(r'^accounttotal$', AccountTotalAPIView.as_view(), name='accounttotal'), # /api/aggregate/grouptotal/1/?base=EUR
    ...
    url(r'^dashboard$', DashboardAPIView.as_view(), name='dashboard'), # /api/cashflow/forecast

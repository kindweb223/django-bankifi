...
schema_view = get_schema_view(title='Bankifi API', renderer_classes=[OpenAPIRenderer, SwaggerUIRenderer])
...
urlpatterns = [
    ...
    # url(r'^invoice$', InvoiceListAPIView.as_view(), name='invoicelist'), # /api/cashflow/invoice
    # url(r'^invoice/create$', InvoiceCreateAPIView.as_view(), name='invoicecreate'), # /api/cashflow/invoice/create
    # url(r'^invoice/(?P<pk>[0-9]+)/$', InvoiceDetailAPIView.as_view(), name='invoicedetail'), # /api/casflow/invoice/{}/delete
    ...
    url(r'^forecast$', ForecastAPIView.as_view(), name='forecast'), # /api/cashflow/forecast
]